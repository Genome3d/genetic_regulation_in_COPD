...
9. [GWAS Catalog](https://www.ebi.ac.uk/gwas/docs/file-downloads) was downloaded on ??? and queried for SNP-trait associations on 22/11/2021.  
...
To identify spatial regulatory interactions across lung tissue (using GTEx lung eQTL data), we run CoDeS3D pipeline as follows: `python codes3d/codes3d.py -s data/snps/263_COPD_snps_5E-8.txt -o results/codes3d/non-spatial_lung -t Lung --non-spatial`.
