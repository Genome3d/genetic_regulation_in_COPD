...
sp_lung <- read.table(gzfile("results/codes3d/lung/significant_eqtls.txt.gz"), header = TRUE,
                      sep = "\t") # 151
...
## 1.6. Number of human protein-protein interactions (PPI) in the STRING PPI network and lung-specific PPI network.
...
## 3.1. Number of unique human proteins in the STRING PPI network and the lung-specific PPI network.
