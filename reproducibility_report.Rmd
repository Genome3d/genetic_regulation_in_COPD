...
lung_tpm <- vroom(file=gzfile("./data/GTEx_Analysis_2017-06-05_v8_RNASeQCv1.1.9_gene_median_tpm.gct.gz"), delim = "\t", skip=2, col_select = c("Description", "Lung", "Name"))
lung_tpm <- lung_tpm %>% rename("gencode_id"= Name)
